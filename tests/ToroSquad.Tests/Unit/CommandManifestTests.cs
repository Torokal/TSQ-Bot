...
public sealed class CommandManifestTests
{
    ...
    public async Task Production_manifest_is_valid_and_contains_exactly_the_specified_commands()
    {
        ...
        manifest.Commands.Select(c => c.Name).Should().BeEquivalentTo("help", "bot", "privacy", "setup", "modules", "esports", "esports-admin", "f1", "f1-admin", "volleyball", "volleyball-admin", "live-admin");
    ...
    public async Task Admin_and_user_commands_are_separated_by_default_member_permissions()
    {
        ...
        foreach (var name in new[] { "setup", "modules", "esports-admin", "f1-admin", "volleyball-admin", "live-admin" })
