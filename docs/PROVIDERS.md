...
> (`channels`, `users`, app token) reconciliation; EventSub/webhooks are not used (no public ingress; EventSub WebSocket
> needs a stored user refresh token). Contracts and limits: [live/TSQ_LIVE.md](live/TSQ_LIVE.md).
